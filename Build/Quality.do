...
cd "/Github/Build/Mechanism/Demand effect/Export quality"
...
forvalues k=2000(1)2001{
  ...
  merge m:1 countrycode using "/Github/Data/customs-csmar-ISO", keepusing(iso2 iso3 country)
  keep if _merge==3
  drop _merge
  ren iso3 c_d
...
//Merged all dataset
clear all
cd "/Github/Build/Mechanism/Demand effect/Export quality/HS8_quality/output_year"
...
save "/Github/Build/Mechanism/Demand effect/Export quality/Quality_1_2000-2015", replace
...
//Merged all dataset
clear all
cd "/Github/Build/Mechanism/Demand effect/Export quality/HS4_quality"
local Files: dir . files "*.dta"
clear
append using `Files'
sort fid year
...
save "/Github/Build/Mechanism/Demand effect/Export quality/Quality_2_2000-2015", replace
